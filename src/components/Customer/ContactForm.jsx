        ...
        <div className="p-10"> 
            ...
            <div className="bg-[#FAF2ED] rounded-xl mt-7">
                <form className="flex flex-col p-5">
                    ...
                    <input className="bg-white border-[#967761] border-1 rounded-s mt-3 p-1 shadow-xs text-black autofill:shadow-[inset_0_0_0px_1000px_rgb(255,255,255)] autofill:scheme-light" type="text" id="name" name="name" value={name} onChange={onNameChange}/>
                    ...
                    <input className="bg-white border-[#967761] border-1 rounded-s mt-3 p-1 min-h-15 shadow-xs text-black autofill:shadow-[inset_0_0_0px_1000px_rgb(255,255,255)] autofill:scheme-light" type="text" id="question" name="question" value={question} onChange={onQuestionChange}/>
