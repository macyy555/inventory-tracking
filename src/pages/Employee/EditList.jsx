        ...
        <div className="p-10"> 
            <div className="bg-[#FAF2ED] rounded-xl">
                <form className="flex flex-col p-5">
                    ...
                    <input className="bg-white border-[#967761] border-1 rounded-s mt-3 shadow-xs" type="text" id="in_stock" name="in_stock" value=""/>
                    <label className="text-black mt-3" for="defect">Defect</label>
                    <input className="bg-white border-[#967761] border-1 rounded-s mt-3 shadow-xs" type="text" id="defect" name="defect" value=""/>
